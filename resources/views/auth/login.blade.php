                ...
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card shadow-2-strong" id="login_card">
                        <div class="card-body p-5 text-center">
                            <h3 class="mb-5" id="title_login">{{ __('Login') }}</h3>
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-check d-flex justify-content-start mb-4">
                                    ...
                                    <label class="form-check-label" for="remember" id="label_login">
                                        {{ __('Remember Me') }}
                                    </label>
                                </div>

                                <button type="submit" class="btn btn-primary btn-lg btn-blocky" id="label_login">
                                    {{ __('Login') }}
                                </button>
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link" href="{{ route('password.request') }}" id="label_login">
